    ...
    <main className={styles.main}>
      <div className={styles.container}>
        <div className={styles.welcome}>
          <h3>Hi. I'm the Values Narrator AI.</h3>
          <br />
          ...
          <div className={styles.buttonHeading}>
            <h3>Here are some suggestions to get started:</h3>
          </div>
          ...
          <button className={styles.cardButton} onClick={() => handleButtonClick("Explain a value to a 5 year old. Ask me which of the 10 values I would like explained.")}>Explain a value to a 5 year old</button>
        </div>
